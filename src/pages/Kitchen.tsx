...
type Order = { id: string; orderNumber: number; table: { label: string } | null; notes: string | null; status: 'OPEN' | 'PREPARING'; createdAt: string; items: OrderItem[] }
